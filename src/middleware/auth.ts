import { type NextFunction, type Request, RequestHandler, RequestParamHandler, type Response } from 'express';
...
export async function apiKeyAuth(req: Request, res: Response, next: NextFunction) {
    const apiKey = req.header('x-api-key') ? req.header('x-api-key') : req.query.apiKey?.toString();
